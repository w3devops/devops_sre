...
{{/*
Generate full DNS name for external access
*/}}
{{- define "myapp-chart.externalDNS" -}}
...
*/}}
{{- define "myapp-chart.prometheus.fullname" -}}
{{- printf "%s-prometheus" (include "myapp-chart.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Common prometheus annotations
*/}}
{{- define "myapp-chart.prometheusAnnotations" -}}
